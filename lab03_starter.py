...
#Use list() and range() to create a list of dice values ([1, 2, 3, 4, 5, 6]) instead of the current hard-coded dice values.
...
# Ask the player to input an integer between 1 and 6 for their combat strength (combatStrength) and monster combat
# strength (mCombatStrength). Validate the input to ensure it's an integer between 1 and 6. If the input is invalid,
...
#isValid = combatStrength >=1 or combatStrength <= 6
#
#while not isValid:
